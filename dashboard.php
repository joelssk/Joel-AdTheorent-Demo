...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <div class="container">
     <div class="header">
			...
			<h3 class="text-muted">Joel - AdTheorent Demo</h3>
      </div>
      <br>
	  
      <div class="jumbotron">
        <h1>Welcome <?php echo htmlentities($_SESSION['username']); ?>!</h1>
        <p class="lead">Thanks for checking out my AdTheorent demo.</p>
        <p>I've compiled samples of some of the things I've worked with in the past. This is all over a small SQL login taken from my portal. If you have any questions, please contact me. Thanks again for the opportunity. </p>
      </div>
